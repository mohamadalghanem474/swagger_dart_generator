...
@immutable
class OpcSaveSubscriptionPaymentMethodPostResponse extends Equatable {
  const OpcSaveSubscriptionPaymentMethodPostResponse({
  ...
  static OpcSaveSubscriptionPaymentMethodPostResponse fromJson(
      Map<String, dynamic> json) {
    return OpcSaveSubscriptionPaymentMethodPostResponse(
  ...
  OpcSaveSubscriptionPaymentMethodPostResponse copyWith({
