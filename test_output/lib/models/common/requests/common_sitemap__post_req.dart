...
@immutable
class SitemapPostRequest extends Equatable {
  const SitemapPostRequest({
    this.page_index,
    this.page_number,
    this.page_size,
    this.total_items,
  ...
  static SitemapPostRequest fromJson(Map<String, dynamic> json) {
    return SitemapPostRequest(
      page_index:
