...
@immutable
class NewBillingAddressPostResponse extends Equatable {
  const NewBillingAddressPostResponse({
    this.model,
  ...
  static NewBillingAddressPostResponse fromJson(Map<String, dynamic> json) {
    return NewBillingAddressPostResponse(
  ...
  NewBillingAddressPostResponse copyWith({
    String? model,
