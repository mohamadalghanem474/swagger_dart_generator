...
@immutable
class UploadFileProductAttributePostResponse extends Equatable {
  const UploadFileProductAttributePostResponse({
    this.success,
    this.message,
    this.download_url,
    this.download_guid,
  ...
  static UploadFileProductAttributePostResponse fromJson(
      Map<String, dynamic> json) {
    return UploadFileProductAttributePostResponse(
  ...
  UploadFileProductAttributePostResponse copyWith({
    bool? success,
    String? message,
    String? download_url,
