...
@immutable
class MontyPayReturnUrlPostResponse extends Equatable {
  const MontyPayReturnUrlPostResponse({
  ...
  static MontyPayReturnUrlPostResponse fromJson(Map<String, dynamic> json) {
    return MontyPayReturnUrlPostResponse(
  ...
  MontyPayReturnUrlPostResponse copyWith({
