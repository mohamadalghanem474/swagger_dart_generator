...
@immutable
class CreateOrderPostResponse extends Equatable {
  const CreateOrderPostResponse({
  ...
  static CreateOrderPostResponse fromJson(Map<String, dynamic> json) {
    return CreateOrderPostResponse(
  ...
  CreateOrderPostResponse copyWith({
