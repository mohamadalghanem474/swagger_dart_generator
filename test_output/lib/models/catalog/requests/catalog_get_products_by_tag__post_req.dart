...
@immutable
class GetProductsByTagPostRequest extends Equatable {
  const GetProductsByTagPostRequest({
    this.price,
  ...
  static GetProductsByTagPostRequest fromJson(Map<String, dynamic> json) {
    return GetProductsByTagPostRequest(
  ...
  GetProductsByTagPostRequest copyWith({
    String? price,
