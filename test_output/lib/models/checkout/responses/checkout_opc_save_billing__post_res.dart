...
@immutable
class OpcSaveBillingPostResponse extends Equatable {
  const OpcSaveBillingPostResponse({
  ...
  static OpcSaveBillingPostResponse fromJson(Map<String, dynamic> json) {
    return OpcSaveBillingPostResponse(
  ...
  OpcSaveBillingPostResponse copyWith({
