...
@immutable
class TopicCreatePostRequest extends Equatable {
  const TopicCreatePostRequest({
    this.is_edit,
    this.forum_id,
    this.forum_name,
    this.forum_se_name,
  ...
  static TopicCreatePostRequest fromJson(Map<String, dynamic> json) {
    return TopicCreatePostRequest(
  ...
  TopicCreatePostRequest copyWith({
    bool? is_edit,
    int? forum_id,
    String? forum_name,
