...
ProductsReq productsReqFromJsonString(String str) => ProductsReq.fromJson(json.decode(str));
...
abstract class ProductsReq with _$ProductsReq {
  ...
  factory ProductsReq.fromJson(Map<String, dynamic> json) => _$ProductsReqFromJson(json);
}
