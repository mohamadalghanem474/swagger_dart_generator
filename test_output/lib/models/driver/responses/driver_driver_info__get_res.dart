...
@immutable
class DriverInfoGetResponse extends Equatable {
  const DriverInfoGetResponse({
    this.id,
    this.email,
    this.first_name,
    this.last_name,
  ...
  static DriverInfoGetResponse fromJson(Map<String, dynamic> json) {
    return DriverInfoGetResponse(
  ...
  DriverInfoGetResponse copyWith({
    int? id,
    String? email,
    String? first_name,
    String? last_name,
