...
@immutable
class GetManufacturerProductsPostRequest extends Equatable {
  const GetManufacturerProductsPostRequest({
    this.price,
  ...
  static GetManufacturerProductsPostRequest fromJson(
      Map<String, dynamic> json) {
    return GetManufacturerProductsPostRequest(
  ...
  GetManufacturerProductsPostRequest copyWith({
    String? price,
