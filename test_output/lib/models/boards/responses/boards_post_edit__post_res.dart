...
@immutable
class PostEditPostResponse extends Equatable {
  const PostEditPostResponse({
    this.forum_topic_id,
    this.is_edit,
    this.text,
    this.forum_editor,
  ...
  static PostEditPostResponse fromJson(Map<String, dynamic> json) {
    return PostEditPostResponse(
