...
@immutable
class CreateServiceLogsPostRequest extends Equatable {
  const CreateServiceLogsPostRequest({
    this.odo_meter,
    this.cost,
    this.driver_id,
    this.vehicle_id,
  ...
  static CreateServiceLogsPostRequest fromJson(Map<String, dynamic> json) {
    return CreateServiceLogsPostRequest(
      odo_meter:
  ...
  CreateServiceLogsPostRequest copyWith({
    double? odo_meter,
    double? cost,
    int? driver_id,
    int? vehicle_id,
