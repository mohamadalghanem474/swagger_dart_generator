...
@immutable
class ReturnOrderForMarketPlacePostResponse extends Equatable {
  const ReturnOrderForMarketPlacePostResponse({
    this.ExternalId,
    this.dropLocation,
    this.pickupAddress,
    this.ActualWeight,
  ...
  static ReturnOrderForMarketPlacePostResponse fromJson(
      Map<String, dynamic> json) {
    return ReturnOrderForMarketPlacePostResponse(
      ExternalId:
  ...
  ReturnOrderForMarketPlacePostResponse copyWith({
    String? ExternalId,
    String? dropLocation,
