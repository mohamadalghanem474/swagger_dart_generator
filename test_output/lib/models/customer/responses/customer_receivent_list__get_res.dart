...
@immutable
class ReceiventListGetResponse extends Equatable {
  const ReceiventListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static ReceiventListGetResponse fromJson(Map<String, dynamic> json) {
    return ReceiventListGetResponse(
      total_count:
  ...
  ReceiventListGetResponse copyWith({
    int? total_count,
    int? total_pages,
