...
@immutable
class CreateOrderForMarketPlacePostRequest extends Equatable {
  const CreateOrderForMarketPlacePostRequest({
  ...
  static CreateOrderForMarketPlacePostRequest fromJson(
      Map<String, dynamic> json) {
    return CreateOrderForMarketPlacePostRequest(
  ...
  CreateOrderForMarketPlacePostRequest copyWith({
