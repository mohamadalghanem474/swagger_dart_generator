...
@immutable
class SelectShippingMethodPostResponse extends Equatable {
  const SelectShippingMethodPostResponse({
  ...
  static SelectShippingMethodPostResponse fromJson(Map<String, dynamic> json) {
    return SelectShippingMethodPostResponse(
  ...
  SelectShippingMethodPostResponse copyWith({
