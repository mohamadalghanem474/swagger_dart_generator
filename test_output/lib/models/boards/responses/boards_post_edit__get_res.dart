...
@immutable
class PostEditGetResponse extends Equatable {
  const PostEditGetResponse({
    this.forum_topic_id,
    this.is_edit,
    this.text,
    this.forum_editor,
  ...
  static PostEditGetResponse fromJson(Map<String, dynamic> json) {
    return PostEditGetResponse(
