...
@immutable
class ContactVendorSendPostRequest extends Equatable {
  const ContactVendorSendPostRequest({
    this.vendor_id,
    this.vendor_name,
    this.email,
    this.subject,
  ...
  static ContactVendorSendPostRequest fromJson(Map<String, dynamic> json) {
    return ContactVendorSendPostRequest(
  ...
  ContactVendorSendPostRequest copyWith({
    int? vendor_id,
    String? vendor_name,
    String? email,
    String? subject,
