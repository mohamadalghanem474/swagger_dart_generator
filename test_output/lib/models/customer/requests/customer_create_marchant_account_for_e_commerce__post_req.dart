...
@immutable
class CreateMarchantAccountForECommercePostRequest extends Equatable {
  const CreateMarchantAccountForECommercePostRequest({
    this.Email,
    this.FirstName,
    this.LastName,
    this.Company,
  ...
  static CreateMarchantAccountForECommercePostRequest fromJson(
      Map<String, dynamic> json) {
    return CreateMarchantAccountForECommercePostRequest(
  ...
  CreateMarchantAccountForECommercePostRequest copyWith({
    String? Email,
    String? FirstName,
    String? LastName,
    String? Company,
