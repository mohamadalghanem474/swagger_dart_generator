...
@immutable
class UploadFileReturnRequestPostResponse extends Equatable {
  const UploadFileReturnRequestPostResponse({
    this.success,
    this.message,
    this.download_url,
    this.download_guid,
  ...
  static UploadFileReturnRequestPostResponse fromJson(
      Map<String, dynamic> json) {
    return UploadFileReturnRequestPostResponse(
  ...
  UploadFileReturnRequestPostResponse copyWith({
    bool? success,
    String? message,
    String? download_url,
