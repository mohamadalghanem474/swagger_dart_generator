...
@immutable
class ManageTeamGetResponse extends Equatable {
  const ManageTeamGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static ManageTeamGetResponse fromJson(Map<String, dynamic> json) {
    return ManageTeamGetResponse(
      total_count:
  ...
  ManageTeamGetResponse copyWith({
    int? total_count,
    int? total_pages,
