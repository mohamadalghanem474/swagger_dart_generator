...
@immutable
class MontyPayReturnUrlPostRequest extends Equatable {
  const MontyPayReturnUrlPostRequest({
    this.IsSettled,
  ...
  static MontyPayReturnUrlPostRequest fromJson(Map<String, dynamic> json) {
    return MontyPayReturnUrlPostRequest(
  ...
  MontyPayReturnUrlPostRequest copyWith({
    bool? IsSettled,
