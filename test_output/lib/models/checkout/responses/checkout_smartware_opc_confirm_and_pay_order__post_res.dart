...
@immutable
class SmartwareOpcConfirmAndPayOrderPostResponse extends Equatable {
  const SmartwareOpcConfirmAndPayOrderPostResponse({
  ...
  static SmartwareOpcConfirmAndPayOrderPostResponse fromJson(
      Map<String, dynamic> json) {
    return SmartwareOpcConfirmAndPayOrderPostResponse(
  ...
  SmartwareOpcConfirmAndPayOrderPostResponse copyWith({
