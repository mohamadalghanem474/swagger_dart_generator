...
@immutable
class SendPMPostResponse extends Equatable {
  const SendPMPostResponse({
    this.to_customer_id,
  ...
  static SendPMPostResponse fromJson(Map<String, dynamic> json) {
    return SendPMPostResponse(
