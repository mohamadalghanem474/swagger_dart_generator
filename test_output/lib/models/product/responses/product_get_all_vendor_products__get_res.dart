...
@immutable
class GetAllVendorProductsGetResponse extends Equatable {
  const GetAllVendorProductsGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static GetAllVendorProductsGetResponse fromJson(Map<String, dynamic> json) {
    return GetAllVendorProductsGetResponse(
      total_count:
  ...
  GetAllVendorProductsGetResponse copyWith({
    int? total_count,
    int? total_pages,
