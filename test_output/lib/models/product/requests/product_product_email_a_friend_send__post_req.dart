...
@immutable
class ProductEmailAFriendSendPostRequest extends Equatable {
  const ProductEmailAFriendSendPostRequest({
    this.product_id,
    this.product_name,
  ...
  static ProductEmailAFriendSendPostRequest fromJson(
      Map<String, dynamic> json) {
    return ProductEmailAFriendSendPostRequest(
      product_id:
  ...
  ProductEmailAFriendSendPostRequest copyWith({
    int? product_id,
    String? product_name,
