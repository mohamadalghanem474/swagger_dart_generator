...
@immutable
class CustomerForumSubscriptionsPOSTPostResponse extends Equatable {
  const CustomerForumSubscriptionsPOSTPostResponse({
  ...
  static CustomerForumSubscriptionsPOSTPostResponse fromJson(
      Map<String, dynamic> json) {
    return CustomerForumSubscriptionsPOSTPostResponse(
  ...
  CustomerForumSubscriptionsPOSTPostResponse copyWith({
