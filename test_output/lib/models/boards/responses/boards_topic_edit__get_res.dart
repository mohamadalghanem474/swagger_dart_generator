...
@immutable
class TopicEditGetResponse extends Equatable {
  const TopicEditGetResponse({
    this.is_edit,
    this.forum_id,
    this.forum_name,
    this.forum_se_name,
  ...
  static TopicEditGetResponse fromJson(Map<String, dynamic> json) {
    return TopicEditGetResponse(
