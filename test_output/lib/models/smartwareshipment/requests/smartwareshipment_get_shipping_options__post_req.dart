...
@immutable
class GetShippingOptionsPostRequest extends Equatable {
  const GetShippingOptionsPostRequest({
    this.shipmentId,
    this.CODCurrency,
    this.COdCurrency2,
    this.CODAmount2,
  ...
  static GetShippingOptionsPostRequest fromJson(Map<String, dynamic> json) {
    return GetShippingOptionsPostRequest(
      shipmentId:
  ...
  GetShippingOptionsPostRequest copyWith({
    int? shipmentId,
    String? CODCurrency,
    String? COdCurrency2,
    double? CODAmount2,
