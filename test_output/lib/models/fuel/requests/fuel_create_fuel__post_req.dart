...
@immutable
class CreateFuelPostRequest extends Equatable {
  const CreateFuelPostRequest({
    this.vehicle_id,
    this.driver_id,
    this.vendor_id,
    this.liter,
  ...
  static CreateFuelPostRequest fromJson(Map<String, dynamic> json) {
    return CreateFuelPostRequest(
      vehicle_id:
  ...
  CreateFuelPostRequest copyWith({
    int? vehicle_id,
    int? driver_id,
    int? vendor_id,
    int? liter,
