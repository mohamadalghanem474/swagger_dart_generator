...
@immutable
class GetTokenExternalPostResponse extends Equatable {
  const GetTokenExternalPostResponse({
    this.username,
    this.customer_id,
    this.vendor_id,
    this.store_id,
  ...
  static GetTokenExternalPostResponse fromJson(Map<String, dynamic> json) {
    return GetTokenExternalPostResponse(
  ...
  GetTokenExternalPostResponse copyWith({
    String? username,
    int? customer_id,
    int? vendor_id,
    int? store_id,
