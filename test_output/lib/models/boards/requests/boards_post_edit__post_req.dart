...
@immutable
class PostEditPostRequest extends Equatable {
  const PostEditPostRequest({
    this.forum_topic_id,
    this.is_edit,
    this.text,
    this.forum_editor,
  ...
  static PostEditPostRequest fromJson(Map<String, dynamic> json) {
    return PostEditPostRequest(
