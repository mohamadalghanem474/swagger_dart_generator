...
@immutable
class NewsCommentAddPostRequest extends Equatable {
  const NewsCommentAddPostRequest({
    this.meta_keywords,
  ...
  static NewsCommentAddPostRequest fromJson(Map<String, dynamic> json) {
    return NewsCommentAddPostRequest(
  ...
  NewsCommentAddPostRequest copyWith({
