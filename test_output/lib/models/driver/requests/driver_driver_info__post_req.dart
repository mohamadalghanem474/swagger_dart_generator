...
@immutable
class DriverInfoPostRequest extends Equatable {
  const DriverInfoPostRequest({
    this.id,
    this.email,
    this.first_name,
    this.last_name,
  ...
  static DriverInfoPostRequest fromJson(Map<String, dynamic> json) {
    return DriverInfoPostRequest(
  ...
  DriverInfoPostRequest copyWith({
    int? id,
    String? email,
    String? first_name,
    String? last_name,
