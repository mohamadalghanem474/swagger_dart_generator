...
@immutable
class BlogByTagPostResponse extends Equatable {
  const BlogByTagPostResponse({
  ...
  static BlogByTagPostResponse fromJson(Map<String, dynamic> json) {
    return BlogByTagPostResponse(
  ...
  BlogByTagPostResponse copyWith({
