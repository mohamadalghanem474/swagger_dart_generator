...
@immutable
class UpdateServiceLogPutRequest extends Equatable {
  const UpdateServiceLogPutRequest({
    this.odo_meter,
    this.cost,
    this.driver_id,
    this.vehicle_id,
  ...
  static UpdateServiceLogPutRequest fromJson(Map<String, dynamic> json) {
    return UpdateServiceLogPutRequest(
      odo_meter:
  ...
  UpdateServiceLogPutRequest copyWith({
    double? odo_meter,
    double? cost,
    int? driver_id,
    int? vehicle_id,
