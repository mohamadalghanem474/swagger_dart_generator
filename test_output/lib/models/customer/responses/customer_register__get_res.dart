...
@immutable
class RegisterGetResponse extends Equatable {
  const RegisterGetResponse({
    this.email,
    this.first_name,
    this.last_name,
    this.company,
  ...
  static RegisterGetResponse fromJson(Map<String, dynamic> json) {
    return RegisterGetResponse(
