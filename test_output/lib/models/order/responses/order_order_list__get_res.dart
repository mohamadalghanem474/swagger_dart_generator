...
@immutable
class OrderListGetResponse extends Equatable {
  const OrderListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static OrderListGetResponse fromJson(Map<String, dynamic> json) {
