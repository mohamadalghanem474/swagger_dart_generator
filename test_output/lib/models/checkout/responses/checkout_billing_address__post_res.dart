...
@immutable
class BillingAddressPostResponse extends Equatable {
  const BillingAddressPostResponse({
  ...
  static BillingAddressPostResponse fromJson(Map<String, dynamic> json) {
    return BillingAddressPostResponse(
  ...
  BillingAddressPostResponse copyWith({
