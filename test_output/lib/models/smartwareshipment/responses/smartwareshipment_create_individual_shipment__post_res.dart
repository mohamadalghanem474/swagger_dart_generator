...
@immutable
class CreateIndividualShipmentPostResponse extends Equatable {
  const CreateIndividualShipmentPostResponse({
    this.pickupAddress,
    this.dropOffAddress,
    this.ActualWeight,
    this.PackageType,
  ...
  static CreateIndividualShipmentPostResponse fromJson(
      Map<String, dynamic> json) {
    return CreateIndividualShipmentPostResponse(
  ...
  CreateIndividualShipmentPostResponse copyWith({
