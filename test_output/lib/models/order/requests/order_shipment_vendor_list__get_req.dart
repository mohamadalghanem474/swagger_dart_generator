...
@immutable
class ShipmentVendorListGetRequest extends Equatable {
  const ShipmentVendorListGetRequest({
    this.vendorid,
    this.warehouseid,
  ...
  static ShipmentVendorListGetRequest fromJson(Map<String, dynamic> json) {
    return ShipmentVendorListGetRequest(
      ...
      sendername:
          json['sendername'] == null ? null : (json['sendername'] as String),
      receiventname: json['receiventname'] == null
          ? null
          : (json['receiventname'] as String),
      pickupcountry: json['pickupcountry'] == null
          ? null
          : (json['pickupcountry'] as String),
      stickerlabelid: json['stickerlabelid'] == null
          ? null
          : (json['stickerlabelid'] as int),
  ...
  ShipmentVendorListGetRequest copyWith({
    int? vendorid,
    int? warehouseid,
    ...
    return ShipmentVendorListGetRequest(
      ...
      stickerlabelid: stickerlabelid ?? this.stickerlabelid,
