...
@immutable
class NotificationStatusListGetResponse extends Equatable {
  const NotificationStatusListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static NotificationStatusListGetResponse fromJson(Map<String, dynamic> json) {
    return NotificationStatusListGetResponse(
      total_count:
  ...
  NotificationStatusListGetResponse copyWith({
    int? total_count,
    int? total_pages,
