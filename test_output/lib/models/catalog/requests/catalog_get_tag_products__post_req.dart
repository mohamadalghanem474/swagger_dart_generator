...
@immutable
class GetTagProductsPostRequest extends Equatable {
  const GetTagProductsPostRequest({
    this.price,
  ...
  static GetTagProductsPostRequest fromJson(Map<String, dynamic> json) {
    return GetTagProductsPostRequest(
  ...
  GetTagProductsPostRequest copyWith({
    String? price,
