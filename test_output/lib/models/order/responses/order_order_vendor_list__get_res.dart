...
@immutable
class OrderVendorListGetResponse extends Equatable {
  const OrderVendorListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static OrderVendorListGetResponse fromJson(Map<String, dynamic> json) {
    return OrderVendorListGetResponse(
      total_count:
  ...
  OrderVendorListGetResponse copyWith({
    int? total_count,
    int? total_pages,
