...
@immutable
class PaymentRedirectActionPostResponse extends Equatable {
  const PaymentRedirectActionPostResponse({
  ...
  static PaymentRedirectActionPostResponse fromJson(Map<String, dynamic> json) {
    return PaymentRedirectActionPostResponse(
  ...
  PaymentRedirectActionPostResponse copyWith({
