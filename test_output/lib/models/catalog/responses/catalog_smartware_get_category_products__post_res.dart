...
@immutable
class SmartwareGetCategoryProductsPostResponse extends Equatable {
  const SmartwareGetCategoryProductsPostResponse({
  ...
  static SmartwareGetCategoryProductsPostResponse fromJson(
      Map<String, dynamic> json) {
    return SmartwareGetCategoryProductsPostResponse(
  ...
  SmartwareGetCategoryProductsPostResponse copyWith({
