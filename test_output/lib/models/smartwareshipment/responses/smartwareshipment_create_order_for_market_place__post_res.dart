...
@immutable
class CreateOrderForMarketPlacePostResponse extends Equatable {
  const CreateOrderForMarketPlacePostResponse({
    this.ExternalId,
    this.dropLocation,
    this.pickupAddress,
    this.ActualWeight,
  ...
  static CreateOrderForMarketPlacePostResponse fromJson(
      Map<String, dynamic> json) {
    return CreateOrderForMarketPlacePostResponse(
      ExternalId:
  ...
  CreateOrderForMarketPlacePostResponse copyWith({
    String? ExternalId,
    String? dropLocation,
