...
@immutable
class SaveEditAddressPostRequest extends Equatable {
  const SaveEditAddressPostRequest({
  ...
  static SaveEditAddressPostRequest fromJson(Map<String, dynamic> json) {
    return SaveEditAddressPostRequest(
  ...
  SaveEditAddressPostRequest copyWith({
