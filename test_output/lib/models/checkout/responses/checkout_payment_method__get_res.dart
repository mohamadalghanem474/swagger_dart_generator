...
@immutable
class PaymentMethodGetResponse extends Equatable {
  const PaymentMethodGetResponse({
  ...
  static PaymentMethodGetResponse fromJson(Map<String, dynamic> json) {
    return PaymentMethodGetResponse(
      payment_methods:
  ...
  PaymentMethodGetResponse copyWith({
