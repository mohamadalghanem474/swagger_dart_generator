...
@immutable
class CustomerOrdersGetResponse extends Equatable {
  const CustomerOrdersGetResponse({
    this.orders,
  ...
  static CustomerOrdersGetResponse fromJson(Map<String, dynamic> json) {
    return CustomerOrdersGetResponse(
  ...
  CustomerOrdersGetResponse copyWith({
    List<String>? orders,
