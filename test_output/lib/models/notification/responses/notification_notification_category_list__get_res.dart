...
@immutable
class NotificationCategoryListGetResponse extends Equatable {
  const NotificationCategoryListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static NotificationCategoryListGetResponse fromJson(
      Map<String, dynamic> json) {
    return NotificationCategoryListGetResponse(
      total_count:
  ...
  NotificationCategoryListGetResponse copyWith({
    int? total_count,
    int? total_pages,
