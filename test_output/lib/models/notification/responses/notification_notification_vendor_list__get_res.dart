...
@immutable
class NotificationVendorListGetResponse extends Equatable {
  const NotificationVendorListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static NotificationVendorListGetResponse fromJson(Map<String, dynamic> json) {
    return NotificationVendorListGetResponse(
      total_count:
  ...
  NotificationVendorListGetResponse copyWith({
    int? total_count,
    int? total_pages,
