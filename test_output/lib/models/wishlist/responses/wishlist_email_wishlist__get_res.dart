...
@immutable
class EmailWishlistGetResponse extends Equatable {
  const EmailWishlistGetResponse({
    this.friend_email,
  ...
  static EmailWishlistGetResponse fromJson(Map<String, dynamic> json) {
    return EmailWishlistGetResponse(
  ...
  EmailWishlistGetResponse copyWith({
    String? friend_email,
