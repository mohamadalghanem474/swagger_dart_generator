...
@immutable
class PostCreateGetResponse extends Equatable {
  const PostCreateGetResponse({
    this.forum_topic_id,
    this.is_edit,
    this.text,
    this.forum_editor,
  ...
  static PostCreateGetResponse fromJson(Map<String, dynamic> json) {
    return PostCreateGetResponse(
  ...
  PostCreateGetResponse copyWith({
    int? forum_topic_id,
    bool? is_edit,
    String? text,
    String? forum_editor,
