...
abstract class ProductRepository {
  Future<Either<Failure, ProductsRes>> products(ProductsReq req, {CancelToken? cancelToken});
  Future<Either<Failure, ProductsidRes>> productsid(ProductsidReq req, {CancelToken? cancelToken});
}
