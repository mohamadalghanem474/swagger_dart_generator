...
@immutable
class IsOtpExpiredPostResponse extends Equatable {
  const IsOtpExpiredPostResponse({
  ...
  static IsOtpExpiredPostResponse fromJson(Map<String, dynamic> json) {
    return IsOtpExpiredPostResponse(
  ...
  IsOtpExpiredPostResponse copyWith({
