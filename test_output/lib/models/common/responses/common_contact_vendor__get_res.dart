...
@immutable
class ContactVendorGetResponse extends Equatable {
  const ContactVendorGetResponse({
    this.vendor_id,
    this.vendor_name,
    this.email,
    this.subject,
  ...
  static ContactVendorGetResponse fromJson(Map<String, dynamic> json) {
    return ContactVendorGetResponse(
  ...
  ContactVendorGetResponse copyWith({
    int? vendor_id,
    String? vendor_name,
    String? email,
    String? subject,
