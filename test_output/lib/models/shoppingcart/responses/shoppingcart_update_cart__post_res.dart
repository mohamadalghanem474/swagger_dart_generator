...
@immutable
class UpdateCartPostResponse extends Equatable {
  const UpdateCartPostResponse({
  ...
  static UpdateCartPostResponse fromJson(Map<String, dynamic> json) {
    return UpdateCartPostResponse(
  ...
  UpdateCartPostResponse copyWith({
