...
@immutable
class ConfirmPostResponse extends Equatable {
  const ConfirmPostResponse({
  ...
  static ConfirmPostResponse fromJson(Map<String, dynamic> json) {
