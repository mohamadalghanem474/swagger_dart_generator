...
@immutable
class DeliveriesListGetResponse extends Equatable {
  const DeliveriesListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static DeliveriesListGetResponse fromJson(Map<String, dynamic> json) {
    return DeliveriesListGetResponse(
      total_count:
  ...
  DeliveriesListGetResponse copyWith({
    int? total_count,
    int? total_pages,
