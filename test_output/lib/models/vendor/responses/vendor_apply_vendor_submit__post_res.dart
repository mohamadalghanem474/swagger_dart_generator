...
@immutable
class ApplyVendorSubmitPostResponse extends Equatable {
  const ApplyVendorSubmitPostResponse({
    this.name,
    this.email,
    this.description,
  ...
  static ApplyVendorSubmitPostResponse fromJson(Map<String, dynamic> json) {
    return ApplyVendorSubmitPostResponse(
  ...
  ApplyVendorSubmitPostResponse copyWith({
    String? name,
    String? email,
    String? description,
