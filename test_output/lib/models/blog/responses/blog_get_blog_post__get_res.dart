...
@immutable
class GetBlogPostGetResponse extends Equatable {
  const GetBlogPostGetResponse({
    this.meta_keywords,
  ...
  static GetBlogPostGetResponse fromJson(Map<String, dynamic> json) {
    return GetBlogPostGetResponse(
  ...
  GetBlogPostGetResponse copyWith({
