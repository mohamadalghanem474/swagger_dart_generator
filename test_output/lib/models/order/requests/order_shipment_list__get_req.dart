...
@immutable
class ShipmentListGetRequest extends Equatable {
  const ShipmentListGetRequest({
    this.vendorid,
    this.warehouseid,
  ...
  static ShipmentListGetRequest fromJson(Map<String, dynamic> json) {
    return ShipmentListGetRequest(
  ...
  ShipmentListGetRequest copyWith({
    int? vendorid,
    int? warehouseid,
