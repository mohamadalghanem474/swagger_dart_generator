...
@immutable
class OrderVendorListGetRequest extends Equatable {
  const OrderVendorListGetRequest({
    this.storeid,
    this.vendorid,
    this.customerid,
    this.productid,
  ...
  static OrderVendorListGetRequest fromJson(Map<String, dynamic> json) {
    return OrderVendorListGetRequest(
  ...
  OrderVendorListGetRequest copyWith({
    int? storeid,
    int? vendorid,
    int? customerid,
    int? productid,
