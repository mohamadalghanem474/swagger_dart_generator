...
@immutable
class TopicCreatePostResponse extends Equatable {
  const TopicCreatePostResponse({
    this.is_edit,
    this.forum_id,
    this.forum_name,
    this.forum_se_name,
  ...
  static TopicCreatePostResponse fromJson(Map<String, dynamic> json) {
    return TopicCreatePostResponse(
  ...
  TopicCreatePostResponse copyWith({
    bool? is_edit,
    int? forum_id,
    String? forum_name,
