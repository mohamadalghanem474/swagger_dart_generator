...
@immutable
class ReturnRequestGetResponse extends Equatable {
  const ReturnRequestGetResponse({
    this.order_id,
  ...
  static ReturnRequestGetResponse fromJson(Map<String, dynamic> json) {
    return ReturnRequestGetResponse(
  ...
  ReturnRequestGetResponse copyWith({
    int? order_id,
