...
@immutable
class CreateOnDemandShipmentPostRequest extends Equatable {
  const CreateOnDemandShipmentPostRequest({
    this.createAccount,
    this.notifyByEmail,
    this.pickupAddress,
    this.dropOffAddress,
  ...
  static CreateOnDemandShipmentPostRequest fromJson(Map<String, dynamic> json) {
    return CreateOnDemandShipmentPostRequest(
  ...
  CreateOnDemandShipmentPostRequest copyWith({
    bool? createAccount,
    bool? notifyByEmail,
