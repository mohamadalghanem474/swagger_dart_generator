...
@immutable
class GetCategoryPostRequest extends Equatable {
  const GetCategoryPostRequest({
    this.price,
  ...
  static GetCategoryPostRequest fromJson(Map<String, dynamic> json) {
    return GetCategoryPostRequest(
  ...
  GetCategoryPostRequest copyWith({
    String? price,
