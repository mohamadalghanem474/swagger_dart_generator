...
@immutable
class EstimateRatesForMarketplacePostRequest extends Equatable {
  const EstimateRatesForMarketplacePostRequest({
    this.pickupLocation,
  ...
  static EstimateRatesForMarketplacePostRequest fromJson(
      Map<String, dynamic> json) {
    return EstimateRatesForMarketplacePostRequest(
  ...
  EstimateRatesForMarketplacePostRequest copyWith({
