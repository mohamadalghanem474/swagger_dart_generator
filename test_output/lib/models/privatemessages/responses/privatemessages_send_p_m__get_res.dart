...
@immutable
class SendPMGetResponse extends Equatable {
  const SendPMGetResponse({
    this.to_customer_id,
  ...
  static SendPMGetResponse fromJson(Map<String, dynamic> json) {
    return SendPMGetResponse(
