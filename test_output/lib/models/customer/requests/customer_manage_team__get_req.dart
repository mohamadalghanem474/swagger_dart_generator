...
@immutable
class ManageTeamGetRequest extends Equatable {
  const ManageTeamGetRequest({
    this.email,
    this.username,
    this.firstname,
    this.lastname,
  ...
  static ManageTeamGetRequest fromJson(Map<String, dynamic> json) {
    return ManageTeamGetRequest(
