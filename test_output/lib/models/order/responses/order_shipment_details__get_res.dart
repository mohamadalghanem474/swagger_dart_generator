...
@immutable
class ShipmentDetailsGetResponse extends Equatable {
  const ShipmentDetailsGetResponse({
  ...
  static ShipmentDetailsGetResponse fromJson(Map<String, dynamic> json) {
    return ShipmentDetailsGetResponse(
  ...
  ShipmentDetailsGetResponse copyWith({
