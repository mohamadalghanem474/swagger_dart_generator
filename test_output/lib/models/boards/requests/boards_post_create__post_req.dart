...
@immutable
class PostCreatePostRequest extends Equatable {
  const PostCreatePostRequest({
    this.forum_topic_id,
    this.is_edit,
    this.text,
    this.forum_editor,
  ...
  static PostCreatePostRequest fromJson(Map<String, dynamic> json) {
  ...
  PostCreatePostRequest copyWith({
    int? forum_topic_id,
    bool? is_edit,
    String? text,
    String? forum_editor,
