...
@immutable
class BlogByMonthPostResponse extends Equatable {
  const BlogByMonthPostResponse({
  ...
  static BlogByMonthPostResponse fromJson(Map<String, dynamic> json) {
    return BlogByMonthPostResponse(
  ...
  BlogByMonthPostResponse copyWith({
