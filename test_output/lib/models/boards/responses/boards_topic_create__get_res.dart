...
@immutable
class TopicCreateGetResponse extends Equatable {
  const TopicCreateGetResponse({
    this.is_edit,
    this.forum_id,
    this.forum_name,
    this.forum_se_name,
  ...
  static TopicCreateGetResponse fromJson(Map<String, dynamic> json) {
    return TopicCreateGetResponse(
  ...
  TopicCreateGetResponse copyWith({
    bool? is_edit,
    int? forum_id,
    String? forum_name,
