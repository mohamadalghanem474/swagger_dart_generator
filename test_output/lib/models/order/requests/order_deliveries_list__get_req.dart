...
@immutable
class DeliveriesListGetRequest extends Equatable {
  const DeliveriesListGetRequest({
    this.warehouseid,
  ...
  static DeliveriesListGetRequest fromJson(Map<String, dynamic> json) {
    return DeliveriesListGetRequest(
      warehouseid:
  ...
  DeliveriesListGetRequest copyWith({
    int? warehouseid,
