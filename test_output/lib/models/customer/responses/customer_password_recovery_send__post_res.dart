...
@immutable
class PasswordRecoverySendPostResponse extends Equatable {
  const PasswordRecoverySendPostResponse({
    this.email,
    this.result,
  ...
  static PasswordRecoverySendPostResponse fromJson(Map<String, dynamic> json) {
    return PasswordRecoverySendPostResponse(
  ...
  PasswordRecoverySendPostResponse copyWith({
    String? email,
    String? result,
