...
@immutable
class WishlistGetResponse extends Equatable {
  const WishlistGetResponse({
    this.customer_guid,
  ...
  static WishlistGetResponse fromJson(Map<String, dynamic> json) {
    return WishlistGetResponse(
