...
@immutable
class UpdatePutRequest extends Equatable {
  const UpdatePutRequest({
    this.name,
    this.admin_comment,
    this.address_id,
    this.is_active,
  ...
  static UpdatePutRequest fromJson(Map<String, dynamic> json) {
    return UpdatePutRequest(
