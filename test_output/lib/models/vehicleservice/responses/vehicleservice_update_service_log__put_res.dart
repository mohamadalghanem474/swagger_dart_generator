...
@immutable
class UpdateServiceLogPutResponse extends Equatable {
  const UpdateServiceLogPutResponse({
    this.odo_meter,
    this.cost,
    this.driver_id,
    this.vehicle_id,
  ...
  static UpdateServiceLogPutResponse fromJson(Map<String, dynamic> json) {
    return UpdateServiceLogPutResponse(
      odo_meter:
  ...
  UpdateServiceLogPutResponse copyWith({
    double? odo_meter,
    double? cost,
    int? driver_id,
    int? vehicle_id,
