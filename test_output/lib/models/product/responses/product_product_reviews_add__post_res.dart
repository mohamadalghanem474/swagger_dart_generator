...
@immutable
class ProductReviewsAddPostResponse extends Equatable {
  const ProductReviewsAddPostResponse({
    this.product_id,
    this.product_name,
  ...
  static ProductReviewsAddPostResponse fromJson(Map<String, dynamic> json) {
    return ProductReviewsAddPostResponse(
      product_id:
  ...
  ProductReviewsAddPostResponse copyWith({
    int? product_id,
    String? product_name,
