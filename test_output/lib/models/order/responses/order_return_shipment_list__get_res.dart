...
@immutable
class ReturnShipmentListGetResponse extends Equatable {
  const ReturnShipmentListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static ReturnShipmentListGetResponse fromJson(Map<String, dynamic> json) {
    return ReturnShipmentListGetResponse(
      total_count:
  ...
  ReturnShipmentListGetResponse copyWith({
    int? total_count,
    int? total_pages,
