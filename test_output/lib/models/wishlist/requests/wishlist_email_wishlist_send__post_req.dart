...
@immutable
class EmailWishlistSendPostRequest extends Equatable {
  const EmailWishlistSendPostRequest({
    this.friend_email,
  ...
  static EmailWishlistSendPostRequest fromJson(Map<String, dynamic> json) {
    return EmailWishlistSendPostRequest(
  ...
  EmailWishlistSendPostRequest copyWith({
    String? friend_email,
