...
@immutable
class BlogByMonthPostRequest extends Equatable {
  const BlogByMonthPostRequest({
    this.month,
    this.tag,
    this.page_number,
    this.page_size,
  ...
  static BlogByMonthPostRequest fromJson(Map<String, dynamic> json) {
    return BlogByMonthPostRequest(
  ...
  BlogByMonthPostRequest copyWith({
    String? month,
    String? tag,
    int? page_number,
    int? page_size,
