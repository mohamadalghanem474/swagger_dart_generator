...
@immutable
class MontyPayCancelReturnUrlPostResponse extends Equatable {
  const MontyPayCancelReturnUrlPostResponse({
  ...
  static MontyPayCancelReturnUrlPostResponse fromJson(
      Map<String, dynamic> json) {
    return MontyPayCancelReturnUrlPostResponse(
  ...
  MontyPayCancelReturnUrlPostResponse copyWith({
