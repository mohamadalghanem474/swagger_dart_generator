...
@immutable
class RemoveDiscountCouponPostResponse extends Equatable {
  const RemoveDiscountCouponPostResponse({
  ...
  static RemoveDiscountCouponPostResponse fromJson(Map<String, dynamic> json) {
    return RemoveDiscountCouponPostResponse(
  ...
  RemoveDiscountCouponPostResponse copyWith({
