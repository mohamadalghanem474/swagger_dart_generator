...
@immutable
class UpdateFuelPutResponse extends Equatable {
  const UpdateFuelPutResponse({
    this.odo_meter,
    this.cost,
    this.driver_id,
    this.vehicle_id,
  ...
  static UpdateFuelPutResponse fromJson(Map<String, dynamic> json) {
    return UpdateFuelPutResponse(
      odo_meter:
  ...
  UpdateFuelPutResponse copyWith({
    double? odo_meter,
    double? cost,
    int? driver_id,
    int? vehicle_id,
