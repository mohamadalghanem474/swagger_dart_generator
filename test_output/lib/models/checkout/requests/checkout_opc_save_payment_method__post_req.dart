...
@immutable
class OpcSavePaymentMethodPostRequest extends Equatable {
  const OpcSavePaymentMethodPostRequest({
  ...
  static OpcSavePaymentMethodPostRequest fromJson(Map<String, dynamic> json) {
    return OpcSavePaymentMethodPostRequest(
      payment_methods:
  ...
  OpcSavePaymentMethodPostRequest copyWith({
