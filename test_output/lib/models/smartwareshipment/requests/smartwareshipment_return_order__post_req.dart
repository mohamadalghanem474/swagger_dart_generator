...
@immutable
class ReturnOrderPostRequest extends Equatable {
  const ReturnOrderPostRequest({
    this.ExternalId,
    this.dropLocation,
    this.pickupAddress,
    this.ActualWeight,
  ...
  static ReturnOrderPostRequest fromJson(Map<String, dynamic> json) {
    return ReturnOrderPostRequest(
      ExternalId:
  ...
  ReturnOrderPostRequest copyWith({
    String? ExternalId,
    String? dropLocation,
