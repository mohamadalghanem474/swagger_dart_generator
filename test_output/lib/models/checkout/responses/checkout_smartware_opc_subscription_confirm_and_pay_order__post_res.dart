...
@immutable
class SmartwareOpcSubscriptionConfirmAndPayOrderPostResponse extends Equatable {
  const SmartwareOpcSubscriptionConfirmAndPayOrderPostResponse({
  ...
  static SmartwareOpcSubscriptionConfirmAndPayOrderPostResponse fromJson(
      Map<String, dynamic> json) {
    return SmartwareOpcSubscriptionConfirmAndPayOrderPostResponse(
  ...
  SmartwareOpcSubscriptionConfirmAndPayOrderPostResponse copyWith({
