...
@immutable
class PostDeleteDeleteResponse extends Equatable {
  const PostDeleteDeleteResponse({
    this.is_edit,
    this.forum_id,
    this.forum_name,
    this.forum_se_name,
  ...
  static PostDeleteDeleteResponse fromJson(Map<String, dynamic> json) {
    return PostDeleteDeleteResponse(
  ...
  PostDeleteDeleteResponse copyWith({
    bool? is_edit,
    int? forum_id,
    String? forum_name,
