...
@immutable
class ReturnOrderPostResponse extends Equatable {
  const ReturnOrderPostResponse({
  ...
  static ReturnOrderPostResponse fromJson(Map<String, dynamic> json) {
    return ReturnOrderPostResponse(
  ...
  ReturnOrderPostResponse copyWith({
