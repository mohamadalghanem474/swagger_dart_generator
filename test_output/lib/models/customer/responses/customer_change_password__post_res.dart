...
@immutable
class ChangePasswordPostResponse extends Equatable {
  const ChangePasswordPostResponse({
    this.old_password,
    this.new_password,
  ...
  static ChangePasswordPostResponse fromJson(Map<String, dynamic> json) {
    return ChangePasswordPostResponse(
  ...
  ChangePasswordPostResponse copyWith({
    String? old_password,
    String? new_password,
