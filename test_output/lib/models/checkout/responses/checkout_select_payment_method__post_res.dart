...
@immutable
class SelectPaymentMethodPostResponse extends Equatable {
  const SelectPaymentMethodPostResponse({
  ...
  static SelectPaymentMethodPostResponse fromJson(Map<String, dynamic> json) {
    return SelectPaymentMethodPostResponse(
  ...
  SelectPaymentMethodPostResponse copyWith({
