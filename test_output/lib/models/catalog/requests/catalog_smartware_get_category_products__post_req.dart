...
@immutable
class SmartwareGetCategoryProductsPostRequest extends Equatable {
  const SmartwareGetCategoryProductsPostRequest({
    this.price,
  ...
  static SmartwareGetCategoryProductsPostRequest fromJson(
      Map<String, dynamic> json) {
    return SmartwareGetCategoryProductsPostRequest(
  ...
  SmartwareGetCategoryProductsPostRequest copyWith({
    String? price,
