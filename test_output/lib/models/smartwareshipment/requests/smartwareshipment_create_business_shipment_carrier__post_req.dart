...
@immutable
class CreateBusinessShipmentCarrierPostRequest extends Equatable {
  const CreateBusinessShipmentCarrierPostRequest({
    this.shipment_id,
  ...
  static CreateBusinessShipmentCarrierPostRequest fromJson(
      Map<String, dynamic> json) {
    return CreateBusinessShipmentCarrierPostRequest(
      shipment_id:
  ...
  CreateBusinessShipmentCarrierPostRequest copyWith({
    int? shipment_id,
