...
@immutable
class GetVendorProductsPostRequest extends Equatable {
  const GetVendorProductsPostRequest({
    this.price,
  ...
  static GetVendorProductsPostRequest fromJson(Map<String, dynamic> json) {
    return GetVendorProductsPostRequest(
  ...
  GetVendorProductsPostRequest copyWith({
    String? price,
