...
@immutable
class GetVendorPostRequest extends Equatable {
  const GetVendorPostRequest({
    this.price,
  ...
  static GetVendorPostRequest fromJson(Map<String, dynamic> json) {
    return GetVendorPostRequest(
