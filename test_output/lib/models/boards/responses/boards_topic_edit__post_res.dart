...
@immutable
class TopicEditPostResponse extends Equatable {
  const TopicEditPostResponse({
    this.is_edit,
    this.forum_id,
    this.forum_name,
    this.forum_se_name,
  ...
  static TopicEditPostResponse fromJson(Map<String, dynamic> json) {
    return TopicEditPostResponse(
  ...
  TopicEditPostResponse copyWith({
    bool? is_edit,
    int? forum_id,
    String? forum_name,
