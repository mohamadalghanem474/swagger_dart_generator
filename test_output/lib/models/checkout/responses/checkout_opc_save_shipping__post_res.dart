...
@immutable
class OpcSaveShippingPostResponse extends Equatable {
  const OpcSaveShippingPostResponse({
  ...
  static OpcSaveShippingPostResponse fromJson(Map<String, dynamic> json) {
    return OpcSaveShippingPostResponse(
  ...
  OpcSaveShippingPostResponse copyWith({
