...
@immutable
class ShipmentListGetResponse extends Equatable {
  const ShipmentListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static ShipmentListGetResponse fromJson(Map<String, dynamic> json) {
    return ShipmentListGetResponse(
      total_count:
  ...
  ShipmentListGetResponse copyWith({
    int? total_count,
    int? total_pages,
