...
@immutable
class OpcSavePaymentInfoPostResponse extends Equatable {
  const OpcSavePaymentInfoPostResponse({
  ...
  static OpcSavePaymentInfoPostResponse fromJson(Map<String, dynamic> json) {
    return OpcSavePaymentInfoPostResponse(
  ...
  OpcSavePaymentInfoPostResponse copyWith({
