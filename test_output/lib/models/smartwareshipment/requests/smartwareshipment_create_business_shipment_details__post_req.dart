...
@immutable
class CreateBusinessShipmentDetailsPostRequest extends Equatable {
  const CreateBusinessShipmentDetailsPostRequest({
    this.product_dtos,
  ...
  static CreateBusinessShipmentDetailsPostRequest fromJson(
      Map<String, dynamic> json) {
    return CreateBusinessShipmentDetailsPostRequest(
  ...
  CreateBusinessShipmentDetailsPostRequest copyWith({
