...
@immutable
class NotificationVendorListGetRequest extends Equatable {
  const NotificationVendorListGetRequest({
    this.vendorid,
    this.createdonfrom,
    this.createdonto,
  ...
  static NotificationVendorListGetRequest fromJson(Map<String, dynamic> json) {
    return NotificationVendorListGetRequest(
  ...
  NotificationVendorListGetRequest copyWith({
    int? vendorid,
