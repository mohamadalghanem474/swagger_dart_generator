...
@immutable
class SearchProductsPostResponse extends Equatable {
  const SearchProductsPostResponse({
  ...
  static SearchProductsPostResponse fromJson(Map<String, dynamic> json) {
    return SearchProductsPostResponse(
  ...
  SearchProductsPostResponse copyWith({
