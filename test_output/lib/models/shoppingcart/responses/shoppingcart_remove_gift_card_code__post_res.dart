...
@immutable
class RemoveGiftCardCodePostResponse extends Equatable {
  const RemoveGiftCardCodePostResponse({
  ...
  static RemoveGiftCardCodePostResponse fromJson(Map<String, dynamic> json) {
    return RemoveGiftCardCodePostResponse(
  ...
  RemoveGiftCardCodePostResponse copyWith({
