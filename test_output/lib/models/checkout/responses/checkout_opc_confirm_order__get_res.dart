...
@immutable
class OpcConfirmOrderGetResponse extends Equatable {
  const OpcConfirmOrderGetResponse({
  ...
  static OpcConfirmOrderGetResponse fromJson(Map<String, dynamic> json) {
    return OpcConfirmOrderGetResponse(
  ...
  OpcConfirmOrderGetResponse copyWith({
