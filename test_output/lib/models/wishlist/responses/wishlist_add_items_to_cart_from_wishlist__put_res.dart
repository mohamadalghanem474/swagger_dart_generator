...
@immutable
class AddItemsToCartFromWishlistPutResponse extends Equatable {
  const AddItemsToCartFromWishlistPutResponse({
    this.customer_guid,
  ...
  static AddItemsToCartFromWishlistPutResponse fromJson(
      Map<String, dynamic> json) {
    return AddItemsToCartFromWishlistPutResponse(
  ...
  AddItemsToCartFromWishlistPutResponse copyWith({
