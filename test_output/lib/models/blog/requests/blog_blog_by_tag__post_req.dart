...
@immutable
class BlogByTagPostRequest extends Equatable {
  const BlogByTagPostRequest({
    this.month,
    this.tag,
    this.page_number,
    this.page_size,
  ...
  static BlogByTagPostRequest fromJson(Map<String, dynamic> json) {
    return BlogByTagPostRequest(
