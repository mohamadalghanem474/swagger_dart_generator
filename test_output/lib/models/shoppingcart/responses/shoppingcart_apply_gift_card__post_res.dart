...
@immutable
class ApplyGiftCardPostResponse extends Equatable {
  const ApplyGiftCardPostResponse({
  ...
  static ApplyGiftCardPostResponse fromJson(Map<String, dynamic> json) {
    return ApplyGiftCardPostResponse(
  ...
  ApplyGiftCardPostResponse copyWith({
