...
@immutable
class ContactUsSendPostResponse extends Equatable {
  const ContactUsSendPostResponse({
    this.email,
    this.subject,
  ...
  static ContactUsSendPostResponse fromJson(Map<String, dynamic> json) {
    return ContactUsSendPostResponse(
  ...
  ContactUsSendPostResponse copyWith({
    String? email,
    String? subject,
