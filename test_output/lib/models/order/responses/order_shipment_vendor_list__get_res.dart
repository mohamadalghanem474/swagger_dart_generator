...
@immutable
class ShipmentVendorListGetResponse extends Equatable {
  const ShipmentVendorListGetResponse({
    this.total_count,
    this.total_pages,
  ...
  static ShipmentVendorListGetResponse fromJson(Map<String, dynamic> json) {
    return ShipmentVendorListGetResponse(
      total_count:
  ...
  ShipmentVendorListGetResponse copyWith({
    int? total_count,
    int? total_pages,
