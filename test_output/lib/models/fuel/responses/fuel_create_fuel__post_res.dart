...
@immutable
class CreateFuelPostResponse extends Equatable {
  const CreateFuelPostResponse({
    this.vehicle_id,
    this.driver_id,
    this.vendor_id,
    this.liter,
  ...
  static CreateFuelPostResponse fromJson(Map<String, dynamic> json) {
    return CreateFuelPostResponse(
      vehicle_id:
  ...
  CreateFuelPostResponse copyWith({
    int? vehicle_id,
    int? driver_id,
    int? vendor_id,
    int? liter,
