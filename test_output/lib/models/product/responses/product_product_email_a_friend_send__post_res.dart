...
@immutable
class ProductEmailAFriendSendPostResponse extends Equatable {
  const ProductEmailAFriendSendPostResponse({
    this.product_id,
    this.product_name,
  ...
  static ProductEmailAFriendSendPostResponse fromJson(
      Map<String, dynamic> json) {
    return ProductEmailAFriendSendPostResponse(
      product_id:
  ...
  ProductEmailAFriendSendPostResponse copyWith({
    int? product_id,
    String? product_name,
