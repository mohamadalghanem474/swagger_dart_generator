...
@immutable
class ReceiventVendorListGetRequest extends Equatable {
  const ReceiventVendorListGetRequest({
    this.email,
    this.username,
    this.firstname,
    this.lastname,
  ...
  static ReceiventVendorListGetRequest fromJson(Map<String, dynamic> json) {
    return ReceiventVendorListGetRequest(
  ...
  ReceiventVendorListGetRequest copyWith({
    String? email,
    String? username,
    String? firstname,
    String? lastname,
