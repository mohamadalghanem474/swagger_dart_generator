...
@immutable
class PasswordRecoveryConfirmPOSTPostResponse extends Equatable {
  const PasswordRecoveryConfirmPOSTPostResponse({
    this.new_password,
  ...
  static PasswordRecoveryConfirmPOSTPostResponse fromJson(
      Map<String, dynamic> json) {
    return PasswordRecoveryConfirmPOSTPostResponse(
  ...
  PasswordRecoveryConfirmPOSTPostResponse copyWith({
    String? new_password,
