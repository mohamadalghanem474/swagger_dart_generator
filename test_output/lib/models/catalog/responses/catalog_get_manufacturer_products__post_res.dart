...
@immutable
class GetManufacturerProductsPostResponse extends Equatable {
  const GetManufacturerProductsPostResponse({
  ...
  static GetManufacturerProductsPostResponse fromJson(
      Map<String, dynamic> json) {
    return GetManufacturerProductsPostResponse(
  ...
  GetManufacturerProductsPostResponse copyWith({
