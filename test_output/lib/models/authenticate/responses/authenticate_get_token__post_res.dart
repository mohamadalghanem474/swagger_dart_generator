...
@immutable
class GetTokenPostResponse extends Equatable {
  const GetTokenPostResponse({
    this.username,
    this.customer_id,
    this.vendor_id,
    this.store_id,
  ...
  static GetTokenPostResponse fromJson(Map<String, dynamic> json) {
    return GetTokenPostResponse(
