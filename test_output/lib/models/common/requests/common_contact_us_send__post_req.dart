...
@immutable
class ContactUsSendPostRequest extends Equatable {
  const ContactUsSendPostRequest({
    this.email,
    this.subject,
  ...
  static ContactUsSendPostRequest fromJson(Map<String, dynamic> json) {
    return ContactUsSendPostRequest(
  ...
  ContactUsSendPostRequest copyWith({
    String? email,
    String? subject,
