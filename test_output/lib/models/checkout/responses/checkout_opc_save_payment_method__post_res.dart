...
@immutable
class OpcSavePaymentMethodPostResponse extends Equatable {
  const OpcSavePaymentMethodPostResponse({
  ...
  static OpcSavePaymentMethodPostResponse fromJson(Map<String, dynamic> json) {
    return OpcSavePaymentMethodPostResponse(
  ...
  OpcSavePaymentMethodPostResponse copyWith({
